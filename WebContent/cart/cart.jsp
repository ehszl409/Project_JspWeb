...
<header class="masthead"
	style="background-image: url('img/cart.jpg')">
...
<div class="container">
	...
	<div class="d-flex justify-content-around">
			...
			<a class="btn btn-primary" href="<%=request.getContextPath()%>/item?cmd=list&page=0">더 구경하기!</a>
			<a class="btn btn-success" href="<%=request.getContextPath()%>/order?cmd=addOrder&id=${sessionScope.principal.id}">주문하기</a>
	</div>
