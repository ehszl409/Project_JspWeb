...
<%@ include file="../layout/navigation.jsp" %>
  ...
  <!-- Page Header -->
  <header class="masthead" style="background-image: url('img/paySuccessPage.jpg')">
      ...
      <div class="row">
        ...
        <a href="#">
          ...
          <div class="d-flex align-items-center" >
				...
				<a class="btn btn-Success" href="<%=request.getContextPath()%>/item?cmd=list&page=0">더 주문하기!</a>
				<a class="btn btn-dark" href="<%=request.getContextPath()%>/user?cmd=myPage&id=${sessionScope.principal.id}">마이페이지로!</a>				
				</div>
